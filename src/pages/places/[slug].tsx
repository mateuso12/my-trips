...
import { GetPageBySlugQuery, GetPlaceBySlugQuery, GetPlacesQuery } from 'graphql/generated/queries'
...
export async function getStaticPaths() {
  const { places } = await client.request<GetPlacesQuery>(GET_PLACES, { first: 4 })
